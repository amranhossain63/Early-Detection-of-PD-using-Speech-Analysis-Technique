...
filename = "Dataset_MDVR_KCL/ReadText/HC/ID00_hc_0_0_0.wav"
...
visulization.visualize_sound_sample(filename)
...
folder_hc = r"Dataset_MDVR_KCL/MDVR/ReadText/HC/*.wav"
# the PD patients dataset
folder_pd = r"Dataset_MDVR_KCL/MDVR/ReadText/PD/*.wav"
...
f.convert_to_csv(df_acoustic_features,"Dataset_MDVR_KCL/MDVR/ReadText/chunks/MDVR_acoustic_features")
...
f.convert_to_csv(df_mfcc_features, "Dataset_MDVR_KCL/MDVR/ReadText/chunks/MDVR_mfcc_features")
...
f.convert_to_csv(df_all_features, "Dataset_MDVR_KCL/MDVR/ReadText/chunks/MDVR_all_features")
